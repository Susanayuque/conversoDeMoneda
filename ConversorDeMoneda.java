...
public class ConversorDeMoneda {
    ...
    public static void convertirMoneda(String monedaBase, String monedaTarget, ConsultaMoneda consultaMoneda, Scanner lectura) throws IOException, InterruptedException {
